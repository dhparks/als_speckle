...
class _FFTParams:
	...
	def __init__(self, shape, dtype, context, fast_math, axes):
...
class FFTPlan:
	...
	def __init__(self, context, shape, dtype=numpy.complex64, normalize=True,
		wait_for_finish=None, fast_math=True, scale=1.0, axes = None):
		...
		self._params = _FFTParams(shape, dtype, context, fast_math, axes)
