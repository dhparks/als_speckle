...
unwrap_R   = unwrap_r+257 # outer radius to unwrap; uR-ur should be a power of 2?
step_size  = 64           # step size between illumination sites
view_size  = 256          # this limits the field of view. the total number of sites is (view_size/step_size)**2
...
interrupts = ('illluminated','speckle_blocker','correlation','spectrum')
